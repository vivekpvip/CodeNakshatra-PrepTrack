  ...
  return (
    <header className="h-16 border-b border-[var(--border)] flex items-center justify-between px-6" style={{ backgroundColor: 'var(--bg-secondary)' }}>
      <div className="flex items-center gap-4">
        <button
          onClick={open}
          className="hidden sm:flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-[var(--text-muted)] cursor-pointer hover:bg-[rgba(255,255,255,0.03)] hover:text-[var(--text-secondary)] transition-colors"
